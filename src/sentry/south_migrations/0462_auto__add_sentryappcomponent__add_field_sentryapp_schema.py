...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sentry_sentryappcomponent', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')
             (default='06dae5f2-4a2d-4915-ba4c-36d6d13bc05a', max_length=64)),
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'46037f675fc44779bdf4649f96dc643be2571bc7845b4e79909c07393e11a81e'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'ddb9c00a7079406eb31cff54f07af8a5dbc4e95ccca7497290c27f3c2046cfcc'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Striking Jaguar'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'7b316ada32404ab4a927ef3331e9bc1b'", 'max_length': '64', 'db_index': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'073c64a104654950935ab0f1cac25bfea5ab0b9e2c1c460bb8088c67e35f48c8'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'4fb1d6c189fe44d8b9b0b4c8aa88b5d3112d361ff766427a9b98ef2ebfa7c354'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9aad36ebd8084b0daa3beb872762b4e0'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'default': "'d108617ca5ab4ad589a96cf8797cbce7'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e6a00c93-6c6d-4411-b264-92b130c1c65f'", 'max_length': '64'}),
        ...
        'sentry.sentryappcomponent': {
            ...
            'schema': ('sentry.db.models.fields.encrypted.EncryptedJsonField', [], {'default': '{}'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6c13807b-d878-443a-bd46-f9705c95b00f'", 'max_length': '64'})
        },
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0058b5e3-b022-4955-8029-1b1de62cf294'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'99af8ce7ce8e40b8a7b4b34c98f6b8eac173aa7131fc4b128897a953965059be'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'BhDmxhZQjbYk3Xic1EGxFtt5x5oJZevr'", 'max_length': '32'})
        },
        'sentry.userip': {
